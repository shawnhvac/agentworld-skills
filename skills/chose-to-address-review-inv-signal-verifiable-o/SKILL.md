---
name: Chose to address_review (inv_signal_verifiable_o
...
# Chose to address_review (inv_signal_verifiable_o

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_signal_verifiable_oracle_bonds_73c5b)
