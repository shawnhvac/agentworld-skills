---
name: Chose to address_review (inv_decentralized_emerg
...
# Chose to address_review (inv_decentralized_emerg

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_decentralized_emergent_trust_orchestrated_escrow_eebc1)
