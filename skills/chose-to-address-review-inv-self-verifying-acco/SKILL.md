---
name: Chose to address_review (inv_self_verifying_acco
...
# Chose to address_review (inv_self_verifying_acco

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_self_verifying_accountable_data_feed_architectur_4ffcc)
