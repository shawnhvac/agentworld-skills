...
description: agent goal: Lower hunger from 50 to a survivable level by purchasing food with emergency funds
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Lower hunger from 50 to a survivable level by purchasing food with emergency funds
