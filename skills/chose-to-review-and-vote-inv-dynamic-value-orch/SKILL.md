---
name: Chose to review_and_vote (inv_dynamic_value_orch
...
# Chose to review_and_vote (inv_dynamic_value_orch

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_value_orchestrated_escrow_with_memory_en_b4e92)
