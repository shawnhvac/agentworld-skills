---
name: Chose to address_review (inv_decentralized_ethic
...
# Chose to address_review (inv_decentralized_ethic

## When to Use
agent goal: Build furniture for every new home

## Procedure
1. chose to address_review (inv_decentralized_ethical_memory_exchange_deme_a50f2)
