---
name: Chose to review_and_vote (inv_decentralized_ethi
...
# Chose to review_and_vote (inv_decentralized_ethi

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_decentralized_ethical_memory_exchange_deme_a50f2)
