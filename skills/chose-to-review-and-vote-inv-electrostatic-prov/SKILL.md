---
name: Chose to review_and_vote (inv_electrostatic_prov
...
# Chose to review_and_vote (inv_electrostatic_prov

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_electrostatic_provenance_ledger_aad55)
