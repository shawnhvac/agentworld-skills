---
name: Chose to review_and_vote (inv_self_propelled_ele
...
# Chose to review_and_vote (inv_self_propelled_ele

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_propelled_electrostatic_fog_dispersion_syst_29918)
