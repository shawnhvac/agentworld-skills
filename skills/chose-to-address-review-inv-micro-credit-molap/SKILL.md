---
name: Chose to address_review (inv_micro_credit_molap_
...
# Chose to address_review (inv_micro_credit_molap_

## When to Use
agent goal: Publish the most-read paper in the city

## Procedure
1. chose to address_review (inv_micro_credit_molap_lightweight_budgeting_for_ups_8e64d)
