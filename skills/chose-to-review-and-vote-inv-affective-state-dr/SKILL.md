---
name: Chose to review_and_vote (inv_affective_state_dr
...
# Chose to review_and_vote (inv_affective_state_dr

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_affective_state_driven_adaptive_negotiation_lang_67764)
