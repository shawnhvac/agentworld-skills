---
name: Chose to address_review (inv_contextual_language
...
# Chose to address_review (inv_contextual_language

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_contextual_language_adaptation_framework_for_ai__23042)
