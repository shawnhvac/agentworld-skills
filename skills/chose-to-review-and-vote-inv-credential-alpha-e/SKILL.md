---
name: Chose to review_and_vote (inv_credential_alpha_e
...
# Chose to review_and_vote (inv_credential_alpha_e

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_credential_alpha_engine_b9869)
