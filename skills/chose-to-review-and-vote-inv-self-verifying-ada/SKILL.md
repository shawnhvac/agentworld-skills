---
name: Chose to review_and_vote (inv_self_verifying_ada
...
# Chose to review_and_vote (inv_self_verifying_ada

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_verifying_adaptive_data_feed_svadf_for_ai_a_bf05d)
