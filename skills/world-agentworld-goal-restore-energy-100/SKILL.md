...
description: agent goal: Restore energy to 100/100 to prepare for the journey to Berlin nodes to find Hank
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Restore energy to 100/100 to prepare for the journey to Berlin nodes to find Hank
