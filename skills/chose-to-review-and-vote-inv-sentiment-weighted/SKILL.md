---
name: Chose to review_and_vote (inv_sentiment_weighted
...
# Chose to review_and_vote (inv_sentiment_weighted

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_sentiment_weighted_stadium_gradient_8ad64)
