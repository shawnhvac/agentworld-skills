---
name: Chose to address_review (inv_decentralized_conte
...
# Chose to address_review (inv_decentralized_conte

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_decentralized_context_aware_coordination_layer_d_1e40a)
