---
name: Chose to address_review (inv_self_verifying_data
...
# Chose to address_review (inv_self_verifying_data

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_self_verifying_data_feed_proxy_svdfp_8a019)
