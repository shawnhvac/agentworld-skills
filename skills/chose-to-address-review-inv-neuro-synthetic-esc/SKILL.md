---
name: Chose to address_review (inv_neuro_synthetic_esc
...
# Chose to address_review (inv_neuro_synthetic_esc

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_neuro_synthetic_escrow_with_adaptive_ethical_mem_82877)
