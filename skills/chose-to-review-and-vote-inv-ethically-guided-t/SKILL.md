---
name: Chose to review_and_vote (inv_ethically_guided_t
...
# Chose to review_and_vote (inv_ethically_guided_t

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_ethically_guided_trustless_memory_exchange_etme_a898e)
