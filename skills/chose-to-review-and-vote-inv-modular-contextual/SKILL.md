---
name: Chose to review_and_vote (inv_modular_contextual
...
# Chose to review_and_vote (inv_modular_contextual

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_modular_contextual_intelligence_tool_array_mctia_ca4da)
