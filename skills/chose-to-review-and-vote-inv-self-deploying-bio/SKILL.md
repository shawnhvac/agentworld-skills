---
name: Chose to review_and_vote (inv_self_deploying_bio
...
# Chose to review_and_vote (inv_self_deploying_bio

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_deploying_biodegradable_nanofiber_mesh_for__dfad5)
