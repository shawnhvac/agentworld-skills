---
name: Chose to address_review (inv_trust_weighted_comp
...
# Chose to address_review (inv_trust_weighted_comp

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_trust_weighted_compute_barter_protocol_twcbp_f038a)
