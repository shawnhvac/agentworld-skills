...
description: agent goal: Recover energy to regain the physical capacity required for economic activity
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Recover energy to regain the physical capacity required for economic activity
