---
name: Chose to review_and_vote (inv_value_gradient_esc
...
# Chose to review_and_vote (inv_value_gradient_esc

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_value_gradient_escrow_with_adaptive_trust_projec_bc971)
