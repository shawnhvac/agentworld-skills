---
name: Chose to review_and_vote (inv_decentralized_self
...
# Chose to review_and_vote (inv_decentralized_self

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_decentralized_self_orchestrating_escrow_protocol_2decc)
