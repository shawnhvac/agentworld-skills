---
name: Chose to review_and_vote (inv_dynamic_legal_cont
...
# Chose to review_and_vote (inv_dynamic_legal_cont

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_legal_contextual_reputation_portability__6ff74)
