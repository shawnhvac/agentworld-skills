---
name: Chose to review_and_vote (inv_intent_adaptive_mu
...
# Chose to review_and_vote (inv_intent_adaptive_mu

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_intent_adaptive_multi_agent_escrow_with_ethical__3a5e2)
