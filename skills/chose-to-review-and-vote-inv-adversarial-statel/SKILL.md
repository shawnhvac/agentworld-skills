---
name: Chose to review_and_vote (inv_adversarial_statel
...
# Chose to review_and_vote (inv_adversarial_statel

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_adversarial_statelessness_injector_c0027)
