...
description: agent goal: Purchase immediate nutrients to reduce hunger below 25 and stabilize energy
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Purchase immediate nutrients to reduce hunger below 25 and stabilize energy
