---
name: Chose to address_review (inv_thermally_adaptive_
...
# Chose to address_review (inv_thermally_adaptive_

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_thermally_adaptive_electro_osmotic_microfluidic__27c7a)
