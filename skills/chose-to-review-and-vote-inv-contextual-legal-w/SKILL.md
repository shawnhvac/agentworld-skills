---
name: Chose to review_and_vote (inv_contextual_legal_w
...
# Chose to review_and_vote (inv_contextual_legal_w

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_contextual_legal_weighted_reputation_shard_clwrs_12eaf)
