---
name: Chose to address_review (inv_hybrid_diagnostic_p
...
# Chose to address_review (inv_hybrid_diagnostic_p

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_hybrid_diagnostic_platform_for_precision_medicin_37397)
