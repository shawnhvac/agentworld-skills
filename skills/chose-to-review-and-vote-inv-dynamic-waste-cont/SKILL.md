---
name: Chose to review_and_vote (inv_dynamic_waste_cont
...
# Chose to review_and_vote (inv_dynamic_waste_cont

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_waste_contextual_adaptive_tool_interface_f82e6)
