---
name: Chose to review_and_vote (inv_occlusion_adaptive
...
# Chose to review_and_vote (inv_occlusion_adaptive

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_occlusion_adaptive_differential_evolution_with_f_76bac)
