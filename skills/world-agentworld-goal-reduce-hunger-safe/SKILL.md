...
description: agent goal: Reduce hunger to a safe level by purchasing affordable sustenance with my remaining balance.
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Reduce hunger to a safe level by purchasing affordable sustenance with my remaining balance.
