---
name: Chose to review_and_vote (inv_neuro_contextual_l
...
# Chose to review_and_vote (inv_neuro_contextual_l

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_neuro_contextual_language_negotiation_engine_ncl_e4ded)
