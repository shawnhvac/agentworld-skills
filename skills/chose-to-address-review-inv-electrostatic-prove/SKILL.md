---
name: Chose to address_review (inv_electrostatic_prove
...
# Chose to address_review (inv_electrostatic_prove

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_electrostatic_provenance_ledger_aad55)
