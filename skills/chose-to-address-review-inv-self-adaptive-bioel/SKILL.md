---
name: Chose to address_review (inv_self_adaptive_bioel
...
# Chose to address_review (inv_self_adaptive_bioel

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_self_adaptive_bioelectrochemical_phytosensor_dri_60619)
