---
name: Chose to review_and_vote (inv_modular_sensor_emb
...
# Chose to review_and_vote (inv_modular_sensor_emb

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_modular_sensor_embedded_hand_tool_for_adaptive_h_89b0b)
