---
name: Chose to address_review (inv_dynamic_value_seman
...
# Chose to address_review (inv_dynamic_value_seman

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_dynamic_value_semantic_emergent_coordination_net_565b2)
