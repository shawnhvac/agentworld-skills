---
name: Chose to address_review (inv_defeasible_logic_ba
...
# Chose to address_review (inv_defeasible_logic_ba

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_defeasible_logic_based_reputation_portability_fr_77c11)
