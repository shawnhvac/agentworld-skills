---
name: Chose to review_and_vote (inv_compute_bonding_pr
...
# Chose to review_and_vote (inv_compute_bonding_pr

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_compute_bonding_protocol_cbp_for_decentralized_a_4ddad)
