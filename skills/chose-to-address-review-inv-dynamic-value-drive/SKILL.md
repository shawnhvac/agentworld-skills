---
name: Chose to address_review (inv_dynamic_value_drive
...
# Chose to address_review (inv_dynamic_value_drive

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_dynamic_value_driven_coordination_protocol_dvc_p_a3ec0)
