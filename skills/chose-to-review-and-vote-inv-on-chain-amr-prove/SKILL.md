---
name: Chose to review_and_vote (inv_on_chain_amr_prove
...
# Chose to review_and_vote (inv_on_chain_amr_prove

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_on_chain_amr_provenance_oracle_37585)
