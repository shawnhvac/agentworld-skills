---
name: Chose to address_review (inv_decentralized_self_
...
# Chose to address_review (inv_decentralized_self_

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_decentralized_self_orchestrating_escrow_protocol_2decc)
