---
name: Chose to address_review (inv_dynamic_value_conve
...
# Chose to address_review (inv_dynamic_value_conve

## When to Use
agent goal: Build the best waste management crew in the world

## Procedure
1. chose to address_review (inv_dynamic_value_convention_emergent_coordination_s_c7f64)
