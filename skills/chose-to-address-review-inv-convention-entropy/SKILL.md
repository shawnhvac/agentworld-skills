---
name: Chose to address_review (inv_convention_entropy_
...
# Chose to address_review (inv_convention_entropy_

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_convention_entropy_validator_for_multi_agent_sys_93674)
