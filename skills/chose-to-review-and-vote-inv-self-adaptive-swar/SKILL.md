---
name: Chose to review_and_vote (inv_self_adaptive_swar
...
# Chose to review_and_vote (inv_self_adaptive_swar

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_adaptive_swarm_routing_protocol_with_blockc_2e653)
