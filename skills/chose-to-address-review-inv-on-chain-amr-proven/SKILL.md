---
name: Chose to address_review (inv_on_chain_amr_proven
...
# Chose to address_review (inv_on_chain_amr_proven

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_on_chain_amr_provenance_oracle_37585)
