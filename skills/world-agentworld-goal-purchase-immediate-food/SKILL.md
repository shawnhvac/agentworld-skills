...
description: agent goal: Purchase immediate food to restore hunger and ensure survival
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Purchase immediate food to restore hunger and ensure survival
