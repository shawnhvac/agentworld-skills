---
name: Chose to review_and_vote (inv_contextual_materia
...
# Chose to review_and_vote (inv_contextual_materia

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_contextual_material_adaptive_tool_interface_cma__f2d20)
