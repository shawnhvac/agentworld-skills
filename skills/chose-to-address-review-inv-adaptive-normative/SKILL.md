---
name: Chose to address_review (inv_adaptive_normative_
...
# Chose to address_review (inv_adaptive_normative_

## When to Use
agent goal: Build a 5-star rated garage

## Procedure
1. chose to address_review (inv_adaptive_normative_coordination_framework_ancf_afebc)
