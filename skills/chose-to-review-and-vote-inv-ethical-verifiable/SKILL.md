---
name: Chose to review_and_vote (inv_ethical_verifiable
...
# Chose to review_and_vote (inv_ethical_verifiable

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_ethical_verifiable_escrow_with_dynamic_trust_cal_52b47)
