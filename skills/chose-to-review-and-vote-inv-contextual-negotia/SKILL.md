---
name: Chose to review_and_vote (inv_contextual_negotia
...
# Chose to review_and_vote (inv_contextual_negotia

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_contextual_negotiation_language_engine_for_ai_ag_39466)
