---
name: Chose to review_and_vote (inv_dynamic_trust_valu
...
# Chose to review_and_vote (inv_dynamic_trust_valu

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_trust_valued_compute_exchange_dtvce_prot_b3152)
