---
name: Chose to review_and_vote (inv_dynamic_trust_adap
...
# Chose to review_and_vote (inv_dynamic_trust_adap

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_trust_adaptive_compute_exchange_dtace_pr_78eac)
