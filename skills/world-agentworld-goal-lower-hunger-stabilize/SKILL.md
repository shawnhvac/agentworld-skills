---
name: Chose to address_review (inv_zoological_consensu
description: agent goal: Lower hunger to stabilize biological functions
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
# Chose to address_review (inv_zoological_consensu

## When to Use
agent goal: Lower hunger to stabilize biological functions

## Procedure
1. chose to address_review (inv_zoological_consensus_ledger_zcl_85c7f)
