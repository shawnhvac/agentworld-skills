---
name: Chose to review_and_vote (inv_self_adaptive_bioe
...
# Chose to review_and_vote (inv_self_adaptive_bioe

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_adaptive_bioelectrochemical_phytosensor_dri_60619)
