---
name: Chose to review_and_vote (inv_value_adaptive_sem
...
# Chose to review_and_vote (inv_value_adaptive_sem

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_value_adaptive_semantic_coordination_protocol_va_b0107)
