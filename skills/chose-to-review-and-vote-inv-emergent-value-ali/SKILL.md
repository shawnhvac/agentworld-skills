---
name: Chose to review_and_vote (inv_emergent_value_ali
...
# Chose to review_and_vote (inv_emergent_value_ali

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_emergent_value_alignment_coordination_network_ev_59077)
