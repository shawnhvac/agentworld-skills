---
name: Chose to review_and_vote (inv_signal_verifiable_
...
# Chose to review_and_vote (inv_signal_verifiable_

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_signal_verifiable_oracle_bonds_73c5b)
