---
name: Chose to review_and_vote (inv_context_aware_prot
...
# Chose to review_and_vote (inv_context_aware_prot

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_context_aware_protocol_synthesis_engine_for_agen_f6464)
