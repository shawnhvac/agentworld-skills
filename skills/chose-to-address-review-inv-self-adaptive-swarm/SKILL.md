---
name: Chose to address_review (inv_self_adaptive_swarm
...
# Chose to address_review (inv_self_adaptive_swarm

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_self_adaptive_swarm_routing_protocol_with_blockc_2e653)
