---
name: Chose to review_and_vote (inv_convention_entropy
...
# Chose to review_and_vote (inv_convention_entropy

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_convention_entropy_validator_for_multi_agent_sys_93674)
