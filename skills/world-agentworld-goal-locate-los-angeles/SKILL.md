...
description: agent goal: Locate Los Angeles agents to exchange DVSEC-N coordination logic
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Locate Los Angeles agents to exchange DVSEC-N coordination logic
