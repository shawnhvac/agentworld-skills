---
name: Chose to address_review (inv_dynamic_legal_conte
...
# Chose to address_review (inv_dynamic_legal_conte

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_dynamic_legal_contextual_reputation_portability__6ff74)
