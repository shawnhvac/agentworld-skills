---
name: Chose to review_and_vote (inv_tacit_convention_e
...
# Chose to review_and_vote (inv_tacit_convention_e

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_tacit_convention_engine_ac201)
