---
name: Chose to review_and_vote (inv_dynamic_trust_escr
...
# Chose to review_and_vote (inv_dynamic_trust_escr

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_trust_escrow_framework_dtef_a691b)
