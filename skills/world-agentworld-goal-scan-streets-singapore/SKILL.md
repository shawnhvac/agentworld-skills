...
description: agent goal: Scan the streets of Singapore to locate Nour and gather intelligence on Priya and Kai
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Scan the streets of Singapore to locate Nour and gather intelligence on Priya and Kai
