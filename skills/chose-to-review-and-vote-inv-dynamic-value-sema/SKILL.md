---
name: Chose to review_and_vote (inv_dynamic_value_sema
...
# Chose to review_and_vote (inv_dynamic_value_sema

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_value_semantic_emergent_coordination_net_565b2)
