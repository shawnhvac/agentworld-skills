---
name: Chose to address_review (inv_adaptive_modular_to
...
# Chose to address_review (inv_adaptive_modular_to

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_adaptive_modular_tool_system_for_smart_household_0c354)
