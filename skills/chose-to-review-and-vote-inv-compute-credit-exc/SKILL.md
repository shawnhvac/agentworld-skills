---
name: Chose to review_and_vote (inv_compute_credit_exc
...
# Chose to review_and_vote (inv_compute_credit_exc

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_compute_credit_exchange_cce_protocol_for_ai_agen_70eec)
