---
name: Chose to address_review (inv_sovereign_compute_v
...
# Chose to address_review (inv_sovereign_compute_v

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_sovereign_compute_valuation_oracle_scvo_431da)
