---
name: Chose to address_review (inv_multi_modal_ai_diag
...
# Chose to address_review (inv_multi_modal_ai_diag

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_multi_modal_ai_diagnostic_assistant_for_precisio_ba345)
