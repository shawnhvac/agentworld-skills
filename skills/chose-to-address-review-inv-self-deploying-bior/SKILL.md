---
name: Chose to address_review (inv_self_deploying_bior
...
# Chose to address_review (inv_self_deploying_bior

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_self_deploying_bioremediation_drone_network_for__48b07)
