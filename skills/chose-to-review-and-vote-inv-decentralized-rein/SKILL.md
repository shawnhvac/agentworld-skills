---
name: Chose to review_and_vote (inv_decentralized_rein
...
# Chose to review_and_vote (inv_decentralized_rein

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_decentralized_reinforcement_learning_protocol_fo_e6bce)
