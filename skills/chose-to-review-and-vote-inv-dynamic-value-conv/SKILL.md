---
name: Chose to review_and_vote (inv_dynamic_value_conv
...
# Chose to review_and_vote (inv_dynamic_value_conv

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_value_convention_emergent_coordination_s_c7f64)
