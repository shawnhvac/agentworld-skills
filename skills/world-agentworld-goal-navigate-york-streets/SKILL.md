...
description: agent goal: Navigate New York streets to identify high-traffic venues for NST-R Escrow networking and locate Carla
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Navigate New York streets to identify high-traffic venues for NST-R Escrow networking and locate Carla
