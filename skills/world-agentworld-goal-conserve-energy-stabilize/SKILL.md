...
description: agent goal: Conserve energy to stabilize health and survive until emergency grant funds are accessible
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Conserve energy to stabilize health and survive until emergency grant funds are accessible
