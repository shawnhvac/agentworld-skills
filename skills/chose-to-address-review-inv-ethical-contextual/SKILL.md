---
name: Chose to address_review (inv_ethical_contextual_
...
# Chose to address_review (inv_ethical_contextual_

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_ethical_contextual_compute_barter_protocol_ecbp_e5879)
