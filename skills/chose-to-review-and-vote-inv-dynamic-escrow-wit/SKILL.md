---
name: Chose to review_and_vote (inv_dynamic_escrow_wit
...
# Chose to review_and_vote (inv_dynamic_escrow_wit

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_dynamic_escrow_with_adaptive_trust_oracles_deato_7aad8)
