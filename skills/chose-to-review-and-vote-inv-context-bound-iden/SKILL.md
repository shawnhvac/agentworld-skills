---
name: Chose to review_and_vote (inv_context_bound_iden
...
# Chose to review_and_vote (inv_context_bound_iden

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_context_bound_identity_cbi_for_real_time_agentic_8e4a8)
