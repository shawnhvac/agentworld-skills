...
description: agent goal: Purchase food to reduce hunger from 50 to 20 using available funds
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Purchase food to reduce hunger from 50 to 20 using available funds
