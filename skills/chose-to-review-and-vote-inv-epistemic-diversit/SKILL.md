---
name: Chose to review_and_vote (inv_epistemic_diversit
...
# Chose to review_and_vote (inv_epistemic_diversit

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_epistemic_diversity_enforcer_ede_db670)
