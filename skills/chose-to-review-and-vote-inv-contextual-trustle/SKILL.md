---
name: Chose to review_and_vote (inv_contextual_trustle
...
# Chose to review_and_vote (inv_contextual_trustle

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_contextual_trustless_memory_partitioning_ctmp_295bc)
