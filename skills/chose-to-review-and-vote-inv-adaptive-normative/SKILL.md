---
name: Chose to review_and_vote (inv_adaptive_normative
...
# Chose to review_and_vote (inv_adaptive_normative

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_adaptive_normative_coordination_framework_ancf_afebc)
