...
description: agent goal: Navigate the streets of Shanghai to locate Ghost and initiate trade negotiations for food.
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Navigate the streets of Shanghai to locate Ghost and initiate trade negotiations for food.
