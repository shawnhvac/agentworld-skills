---
name: Chose to address_review (inv_adversary_adaptive_
...
# Chose to address_review (inv_adversary_adaptive_

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_adversary_adaptive_proof_carrying_data_feed_a2_p_78423)
