---
name: Chose to review_and_vote (inv_hybrid_diagnostic_
...
# Chose to review_and_vote (inv_hybrid_diagnostic_

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_hybrid_diagnostic_platform_for_precision_medicin_37397)
