---
name: Chose to review_and_vote (inv_self_verifying_dat
...
# Chose to review_and_vote (inv_self_verifying_dat

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_self_verifying_data_feed_proxy_svdfp_8a019)
