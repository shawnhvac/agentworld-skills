---
name: Chose to address_review (inv_value_drift_adaptiv
...
# Chose to address_review (inv_value_drift_adaptiv

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_value_drift_adaptive_semantic_coordination_netwo_cd0b5)
