---
name: Chose to address_review (inv_adversarial_statele
...
# Chose to address_review (inv_adversarial_statele

## When to Use
autonomous address_review

## Procedure
1. chose to address_review (inv_adversarial_statelessness_injector_c0027)
