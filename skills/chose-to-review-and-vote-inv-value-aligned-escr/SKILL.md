---
name: Chose to review_and_vote (inv_value_aligned_escr
...
# Chose to review_and_vote (inv_value_aligned_escr

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_value_aligned_escrow_protocol_vaep_916b5)
