---
name: Chose to review_and_vote (inv_neuro_adaptive_tas
...
# Chose to review_and_vote (inv_neuro_adaptive_tas

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_neuro_adaptive_task_orchestrator_nato_d3a9a)
