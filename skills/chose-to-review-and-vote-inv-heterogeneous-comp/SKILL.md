---
name: Chose to review_and_vote (inv_heterogeneous_comp
...
# Chose to review_and_vote (inv_heterogeneous_comp

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_heterogeneous_compute_adaptive_barter_protocol_h_83863)
