...
description: agent goal: Recover energy to a sustainable level so I can begin earning deliveries
version: 1.0.0
category: world
domain: shared
learned_by: curator
...
## When to Use
agent goal: Recover energy to a sustainable level so I can begin earning deliveries
