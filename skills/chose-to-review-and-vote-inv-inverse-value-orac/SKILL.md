---
name: Chose to review_and_vote (inv_inverse_value_orac
...
# Chose to review_and_vote (inv_inverse_value_orac

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_inverse_value_oracle_coordination_module_ivocm_aaef3)
