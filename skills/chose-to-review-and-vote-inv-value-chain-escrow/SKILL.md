---
name: Chose to review_and_vote (inv_value_chain_escrow
...
# Chose to review_and_vote (inv_value_chain_escrow

## When to Use
autonomous review_and_vote

## Procedure
1. chose to review_and_vote (inv_value_chain_escrow_with_adaptive_trust_anchoring_ac2bd)
